...
var boxboxTests = []struct {
	...
	{ // 2 same position different orientation
		b1: CollisionBox{
			body: &RigidBody{
				inverseMass:          1,
				orientation:          glm.Quat{W: 0.877613, Vec3: glm.Vec3{X: -0.33896565, Y: 0, Z: 0.33896565}},
				position:             glm.Vec3{X: 0, Y: 0, Z: 0},
				inverseInertiaTensor: cuboidInertiaTensor(1, 1, 1, 1),
				linearDamping:        1,
				angularDamping:       1,
		...
		normal:      glm.Vec3{X: 0, Y: -0.3602956, Z: -0.9328382},
		point:       glm.Vec3{X: 0.2062844, Y: -0.5340896, Z: 0.20628464},
	...
	{ // 3 same position/orientation but not aligned with world axis
		...
		normal:      glm.Vec3{X: 0.77020454, Y: 0.59496135, Z: -0.22979543},
		point:       glm.Vec3{X: 1.1353705, Y: 0.6495136, Z: 1.1353705},
		penetration: 2,
		contact:     true,
	},
	{ // 4 diff pos same ori
	...
	{ // 5 diff pos dif ori
		b1: CollisionBox{
			body: &RigidBody{
				inverseMass:          1,
				orientation:          glm.Quat{W: 0.877613, Vec3: glm.Vec3{X: -0.33896565, Y: 0, Z: 0.33896565}},
				position:             glm.Vec3{X: 0.25, Y: 0.25, Z: 0},
				inverseInertiaTensor: cuboidInertiaTensor(1, 1, 1, 1),
				linearDamping:        1,
				angularDamping:       1,
				restitution:          1,
