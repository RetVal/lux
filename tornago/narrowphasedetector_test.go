...
func TestSphereAndSphere(t *testing.T) {
	var tests = []struct {
		...
		},
		{
			...
			normal:      glm.Vec3{X: 0.70710677, Y: 0.70710677, Z: 0},
			point:       glm.Vec3{X: 0.5, Y: 0.5, Z: 0},
		...
		},
		{
			s1: CollisionSphere{
				body: &RigidBody{
					inverseMass:          1,
					orientation:          glm.QuatIdent(),
					position:             glm.Vec3{X: 1, Y: 30, Z: 0},
					velocity:             glm.Vec3{X: 0, Y: 0, Z: 0},
					inverseInertiaTensor: sphereInertiaTensor(1, 1),
					linearDamping:        1,
					angularDamping:       1,
			...
			normal:      glm.Vec3{X: 0, Y: 0, Z: 0},
			point:       glm.Vec3{X: 0, Y: 0, Z: 0},
			penetration: 0,
			contact:     false,
		},
	}
		...
		{ // face-face
			s: CollisionSphere{
				body: &RigidBody{
					inverseMass:          1,
					orientation:          glm.QuatIdent(),
					position:             glm.Vec3{X: 0, Y: 1.5, Z: 0},
					inverseInertiaTensor: sphereInertiaTensor(1, 1),
					linearDamping:        1,
					angularDamping:       1,
				},
			...
			b: CollisionBox{
				...
				halfSize: glm.Vec3{X: 0.5, Y: 0.5, Z: 0.5},
			},
			normal:      glm.Vec3{X: 0, Y: 1, Z: 0},
			point:       glm.Vec3{X: 0, Y: 0.5, Z: 0},
			penetration: 0,
			contact:     true,
		},
		{ // face-face
			s: CollisionSphere{
				body: &RigidBody{
					inverseMass:          1,
					orientation:          glm.QuatIdent(),
					position:             glm.Vec3{X: 0, Y: 1.4, Z: 0},
					inverseInertiaTensor: sphereInertiaTensor(1, 1),
					linearDamping:        1,
					angularDamping:       1,
				},
		...
		{ // face-edge
			s: CollisionSphere{
				body: &RigidBody{
					inverseMass:          1,
					orientation:          glm.QuatIdent(),
					position:             glm.Vec3{X: 0.6, Y: 1.3, Z: 0.6},
					inverseInertiaTensor: sphereInertiaTensor(1, 1),
					linearDamping:        1,
					angularDamping:       1,
				},
			...
			normal:      glm.Vec3{X: 0.12309153, Y: 0.9847319, Z: 0.12309153},
			point:       glm.Vec3{X: 0.5, Y: 0.5, Z: 0.5},
		...
		{ // face-edge
			s: CollisionSphere{
				body: &RigidBody{
					inverseMass:          1,
					orientation:          glm.QuatIdent(),
					position:             glm.Vec3{X: 0.51, Y: 1.1, Z: 0.51},
					inverseInertiaTensor: sphereInertiaTensor(1, 1),
					linearDamping:        1,
					angularDamping:       1,
				},
			...
			normal:      glm.Vec3{X: 0.016662024, Y: 0.9997224, Z: 0.016662024},
			point:       glm.Vec3{X: 0.5, Y: 0.5, Z: 0.5},
		...
		{ // face-edge
			s: CollisionSphere{
				body: &RigidBody{
					inverseMass:          1,
					orientation:          glm.QuatIdent(),
					position:             glm.Vec3{X: 0.51, Y: -0.51, Z: 0.51},
					inverseInertiaTensor: sphereInertiaTensor(1, 1),
					linearDamping:        1,
					angularDamping:       1,
				},
			...
			normal:      glm.Vec3{X: 0.57735026, Y: -0.57735026, Z: 0.57735026},
			point:       glm.Vec3{X: 0.5, Y: -0.5, Z: 0.5},
