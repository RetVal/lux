...
// GetTexParameteriv is an alias for glGetTexParameteriv(glTEXTURE_2D, pname, params)
//
// Documentation reference: https://www.opengl.org/sdk/docs/man/html/glGetTexParameteriv.xhtmlhttps://www.opengl.org/sdk/docs/man/html/glGetTexParameteriv.xhtml
...
func (Texture2D) GetTexLevelParameteriv(level int32, pname uint32, params *int32) {
	gl.GetTexLevelParameteriv(gl.TEXTURE_2D, level, pname, params)
}
