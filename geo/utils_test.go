...
func TestIsConvexQuad(t *testing.T) {
	...
	tests := []struct {
		...
		{
			a:        glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			b:        glm.Vec3{1, 0, 0},
			c:        glm.Vec3{4, 0, 1},
			d:        glm.Vec3{0, 0, 1},
			isconvex: false,
		...
		{
			a:        glm.Vec3{1, 0, 0},
			b:        glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			c:        glm.Vec3{4, 0, 1},
			d:        glm.Vec3{0, 0, 1},
			isconvex: false,
		},
		{
			a:        glm.Vec3{4, 0, 1},
			b:        glm.Vec3{1, 0, 0},
			c:        glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			d:        glm.Vec3{0, 0, 1},
			isconvex: false,
		},
		{
			...
			b:        glm.Vec3{1, 0, 0},
			c:        glm.Vec3{4, 0, 1},
			d:        glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			isconvex: false,
		},
	}
...
func TestExtremePointsAlongDirection(t *testing.T) {
	...
	tests := []struct {
		...
		{
			direction: glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			points: []glm.Vec3{
				{0, 0, 0},
				{10, 10, 0},
				{0, -10, 0},
		...
		{
			direction: glm.Vec3{math.Inf(1), 0, 0},
			points: []glm.Vec3{
				{0, 0, 0},
				{10, 10, 0},
				{0, -10, 0},
...
func TestClosestPointSegmentSegment(t *testing.T) {
	tests := []struct {
		...
		{ // 2
			p0: glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			q0: glm.Vec3{0, 0.5, 0},
			p1: glm.Vec3{-0.5, 0, 0},
			q1: glm.Vec3{0.5, 0, 0},
			s:  math.NaN(),
			t:  math.NaN(),
			u:  math.NaN(),
			c0: glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			c1: glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
		},
		{ // 3
			p0: glm.Vec3{0, -0.5, 0},
			q0: glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			p1: glm.Vec3{-0.5, 0, 0},
			q1: glm.Vec3{0.5, 0, 0},
			s:  math.NaN(),
			t:  math.NaN(),
		...
		{ // 4
			p0: glm.Vec3{0, -0.5, 0},
			q0: glm.Vec3{0, 0.5, 0},
			p1: glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			q1: glm.Vec3{0.5, 0, 0},
			s:  math.NaN(),
			t:  math.NaN(),
			u:  math.NaN(),
		...
		{ // 5
			...
			q0: glm.Vec3{0, 0.5, 0},
			p1: glm.Vec3{-0.5, 0, 0},
			q1: glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			s:  math.NaN(),
			t:  math.NaN(),
			u:  math.NaN(),
			c0: glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
		...
		{ // 9
			p0: glm.Vec3{0, 0, 0},
			q0: glm.Vec3{0, 1, 0},
			p1: glm.Vec3{0.1, 0.5, 0},
			q1: glm.Vec3{1.1, 0.5, 0},
			s:  0.5,
			t:  0,
			u:  0.01000000070780516,
			c0: glm.Vec3{0, 0.5, 0},
			c1: glm.Vec3{0.1, 0.5, 0},
		},
		{ // 10
			p0: glm.Vec3{0.1, 0.5, 0},
			q0: glm.Vec3{1.1, 0.5, 0},
			p1: glm.Vec3{0, 0, 0},
			q1: glm.Vec3{0, 1, 0},
			s:  0,
			t:  0.5,
			u:  0.01000000070780516,
			c0: glm.Vec3{0.1, 0.5, 0},
			c1: glm.Vec3{0, 0.5, 0},
		},
		{ // 11
			p0: glm.Vec3{0.1, 0.5, 0},
...
func TestSqDistPointSegment(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{0, 1, 0}, glm.Vec3{1, 0, 0}, math.NaN()},
		{glm.Vec3{0, 0, 0}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{1, 0, 0}, math.NaN()},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, math.NaN()},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{1, 0, 0}, 1},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{2, 0, 0}, 4},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{-2, 0, 0}, 4},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{-2, 1, 0}, 4},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{-2, 0.5, 0}, 4},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{-2, -1, 0}, 5},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{-2, 2, 0}, 5},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{2, -1, 0}, 5},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{2, 2, 0}, 5},
	}
	for i, test := range tests {
...
func TestClosestPointSegmentPoint(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{0, 1, 0}, glm.Vec3{1, 0, 0},
			math.NaN(), glm.Vec3{math.NaN(), math.NaN(), math.NaN()}},
		{glm.Vec3{0, 0, 0}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{1, 0, 0},
			math.NaN(), glm.Vec3{math.NaN(), math.NaN(), math.NaN()}},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			math.NaN(), glm.Vec3{math.NaN(), math.NaN(), math.NaN()}},
...
func TestClosestPointPointRect2(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{2, 0, -1}, glm.Vec3{-1, 0, 2}, glm.Vec3{0, 0, 0},
			glm.Vec3{math.NaN(), math.NaN(), math.NaN()}},
		{glm.Vec3{-1, 0, -1}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{-1, 0, 2}, glm.Vec3{0, 0, 0},
			glm.Vec3{math.NaN(), math.NaN(), math.NaN()}},
		{glm.Vec3{-1, 0, -1}, glm.Vec3{2, 0, -1}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{0, 0, 0},
			glm.Vec3{math.NaN(), math.NaN(), math.NaN()}},
		{glm.Vec3{-1, 0, -1}, glm.Vec3{2, 0, -1}, glm.Vec3{-1, 0, 2}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			glm.Vec3{math.NaN(), math.NaN(), math.NaN()}},
		{glm.Vec3{0, 0, 0}, glm.Vec3{-1, 0, -1}, glm.Vec3{2, 0, -1}, glm.Vec3{-1, 0, 2},
			glm.Vec3{0, 0, 0}},
		{glm.Vec3{100, 1, 100}, glm.Vec3{-1, 0, -1}, glm.Vec3{2, 0, -1}, glm.Vec3{-1, 0, 2},
			glm.Vec3{2, 0, 2}},
	}
	for i, test := range tests {
		//if i != 5 {
...
func TestClosestPointPointTriangle(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{-1, 0, -1}, glm.Vec3{2, 0, -1}, glm.Vec3{-1, 0, 2},
			glm.Vec3{math.NaN(), math.NaN(), math.NaN()}},
		{glm.Vec3{0, 0, 0}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{2, 0, -1}, glm.Vec3{-1, 0, 2},
			glm.Vec3{math.NaN(), math.NaN(), math.NaN()}},
		{glm.Vec3{0, 0, 0}, glm.Vec3{-1, 0, -1}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{-1, 0, 2},
			glm.Vec3{math.NaN(), math.NaN(), math.NaN()}},
		{glm.Vec3{0, 0, 0}, glm.Vec3{-1, 0, -1}, glm.Vec3{2, 0, -1}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			glm.Vec3{math.NaN(), math.NaN(), math.NaN()}},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{1, 0, 0},
			glm.Vec3{0, 0, 0}},
		{glm.Vec3{-1, -1, -1}, glm.Vec3{1, 0, 0}, glm.Vec3{0, 0, 1}, glm.Vec3{0, 1, 0},
			glm.Vec3{0.33333328366279602, 0.33333334326744080, 0.33333334326744080}},
		{glm.Vec3{2, 0, 0}, glm.Vec3{1, 0, 0}, glm.Vec3{0, 0, 1}, glm.Vec3{0, 1, 0},
			glm.Vec3{1, 0, 0}},
		{glm.Vec3{0, 5, 0}, glm.Vec3{0, 5, 0}, glm.Vec3{1, 5, 0}, glm.Vec3{0, 6, 0},
			glm.Vec3{0, 5, 0}},
		{glm.Vec3{-2, 0, -2}, glm.Vec3{-1, 0, -1}, glm.Vec3{0, 0, 1}, glm.Vec3{1, 0, -1},
			glm.Vec3{-1, 0, -1}},
		{glm.Vec3{0, 0, 2}, glm.Vec3{-1, 0, -1}, glm.Vec3{0, 0, 1}, glm.Vec3{1, 0, -1},
			glm.Vec3{0, 0, 1}},
		{glm.Vec3{2, 0, -2}, glm.Vec3{-1, 0, -1}, glm.Vec3{0, 0, 1}, glm.Vec3{1, 0, -1},
			glm.Vec3{1, 0, -1}},
		{glm.Vec3{-2, 0, 0}, glm.Vec3{-1, 0, -1}, glm.Vec3{0, 0, 1}, glm.Vec3{1, 0, -1},
			glm.Vec3{-0.8, 0, -0.6}},
		{glm.Vec3{2, 0, 0}, glm.Vec3{-1, 0, -1}, glm.Vec3{0, 0, 1}, glm.Vec3{1, 0, -1},
			glm.Vec3{0.8, 0, -0.6}},
		{glm.Vec3{0, 0, -2}, glm.Vec3{-1, 0, -1}, glm.Vec3{0, 0, 1}, glm.Vec3{1, 0, -1},
...
func TestPointOutsidePlane(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{0, 0, 0}, glm.Vec3{0, 0, 0}, glm.Vec3{0, 0, 0},
			false},
		{glm.Vec3{0, 0, 0}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{0, 0, 0}, glm.Vec3{0, 0, 0},
			false},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 0, 0}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{0, 0, 0},
			false},
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 0, 0}, glm.Vec3{0, 0, 0}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			false},
		{glm.Vec3{0, 1, 0}, glm.Vec3{0, 0, 0}, glm.Vec3{1, 0, 0}, glm.Vec3{0, 0, 1},
			false},
		{glm.Vec3{0, -1, 0}, glm.Vec3{0, 0, 0}, glm.Vec3{1, 0, 0}, glm.Vec3{0, 0, 1},
			true},
	}
...
func TestPointsOnOppositeSideOfPlane(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{}, glm.Vec3{}, glm.Vec3{}, glm.Vec3{},
			false},
		{glm.Vec3{}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{}, glm.Vec3{}, glm.Vec3{},
			false},
		{glm.Vec3{}, glm.Vec3{}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{}, glm.Vec3{},
			false},
		{glm.Vec3{}, glm.Vec3{}, glm.Vec3{}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{},
			false},
		{glm.Vec3{}, glm.Vec3{}, glm.Vec3{}, glm.Vec3{}, glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
			false},
		{glm.Vec3{0, 0, 1}, glm.Vec3{0, 0, -1}, glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{1, 0, 0},
			true},
	}
	for i, test := range tests {
...
func TestClosestPointPointTetrahedron(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, glm.Vec3{}, glm.Vec3{}, glm.Vec3{}, glm.Vec3{},
			glm.Vec3{math.NaN(), math.NaN(), math.NaN()}},
		{glm.Vec3{-1, -1, -1}, glm.Vec3{0, 0, 0}, glm.Vec3{1, 0, 0}, glm.Vec3{0, 1, 0}, glm.Vec3{0, 0, 1},
			glm.Vec3{0, 0, 0}},

		{glm.Vec3{0, -2, 0}, glm.Vec3{-1, -1, -1}, glm.Vec3{0, -1, 1}, glm.Vec3{1, -1, -1}, glm.Vec3{0, 1, 0},
			glm.Vec3{0, -1, 0}},
		{glm.Vec3{-1, 1, -1}, glm.Vec3{-1, -1, -1}, glm.Vec3{0, -1, 1}, glm.Vec3{1, -1, -1}, glm.Vec3{0, 1, 0},
			glm.Vec3{-0.33333331346511841, 0.33333337306976318, -0.33333331346511841}},
		{glm.Vec3{1, 1, -1}, glm.Vec3{-1, -1, -1}, glm.Vec3{0, -1, 1}, glm.Vec3{1, -1, -1}, glm.Vec3{0, 1, 0},
			glm.Vec3{0.33333331346511841, 0.33333337306976318, -0.33333331346511841}},
		{glm.Vec3{-1, 1, 1}, glm.Vec3{-1, -1, -1}, glm.Vec3{0, -1, 1}, glm.Vec3{1, -1, -1}, glm.Vec3{0, 1, 0},
			glm.Vec3{0, 0.60000002384185791, 0.20000000298023224}},
		{glm.Vec3{1, 1, 1}, glm.Vec3{-1, -1, -1}, glm.Vec3{0, -1, 1}, glm.Vec3{1, -1, -1}, glm.Vec3{0, 1, 0},
			glm.Vec3{0, 0.60000002384185791, 0.19999998807907104}},
	}
	for i, test := range tests {
...
func TestDistPointPlane(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{500, 1, 0}, glm.Vec3{0, 0, 0}, glm.Vec3{1, 0, 0}, glm.Vec3{0, 0, 1},
			1},
	}
	for i, test := range tests {
...
func TestTestSpherePlane(t *testing.T) {
	tests := []struct {
		...
		{
			Sphere{glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, 1},
			Plane{glm.Vec3{0, 1, 0}, 0},
			false},
		{
			Sphere{glm.Vec3{0, 0, 0}, 1},
			Plane{glm.Vec3{math.NaN(), math.NaN(), math.NaN()}, 0},
			false},
		{
			Sphere{glm.Vec3{0, 0, 0}, math.NaN()},
			Plane{glm.Vec3{0, 1, 0}, 0},
			false},
		{
			Sphere{glm.Vec3{0, 0, 0}, 1},
			Plane{glm.Vec3{0, 1, 0}, math.NaN()},
			false},
		{
			Sphere{glm.Vec3{0, 0, 0}, 1},
			Plane{glm.Vec3{0, 1, 0}, 0},
			true},
		{
			Sphere{glm.Vec3{0, 1.5, 0}, 1},
			Plane{glm.Vec3{0, 1, 0}, 0},
			false},
		{
			Sphere{glm.Vec3{0, 1.5, 0}, 1},
			Plane{glm.NormalizeVec3(glm.Vec3{1, 1, 1}), 0},
			true},
		{
			Sphere{glm.Vec3{0, -1.5, 0}, 1},
			Plane{glm.Vec3{0, 1, 0}, 0},
...
func TestTestOBBPlane(t *testing.T) {
	tests := []struct {
		...
		{
			OBB{glm.Vec3{math.NaN(), math.NaN(), math.NaN()},
...
func TestTestAABBPlane(t *testing.T) {
	tests := []struct {
		...
		{AABB{glmtesting.NaN3, glm.Vec3{0.5, 0.5, 0.5}},
			Plane{glm.Vec3{0, 1, 0}, 0},
			false},
		{AABB{glm.Vec3{0, 0, 0}, glmtesting.NaN3},
			Plane{glm.Vec3{0, 1, 0}, 0},
			false},
		...
		{AABB{glm.Vec3{0, 0, 0}, glm.Vec3{0.5, 0.5, 0.5}},
			Plane{glm.Vec3{0, 1, 0}, 0},
			true},
		{AABB{glm.Vec3{0, 5, 0}, glm.Vec3{0.5, 0.5, 0.5}},
			Plane{glm.Vec3{0, 1, 0}, 5},
			true},
		{AABB{glm.Vec3{0, -5, 0}, glm.Vec3{0.5, 0.5, 0.5}},
			Plane{glm.Vec3{0, 1, 0}, 0},
			false},
...
func TestTestSphereAABB(t *testing.T) {
	tests := []struct {
		...
		{Sphere{glm.Vec3{}, math.NaN()}, AABB{glm.Vec3{0, 0, 0}, glm.Vec3{0.5, 0.5, 0.5}},
			false},
		{Sphere{glm.Vec3{}, 1}, AABB{glm.Vec3{}, glm.Vec3{0.5, 0.5, 0.5}},
			true},
		{Sphere{glm.Vec3{0, 1, 0}, 1}, AABB{glm.Vec3{}, glm.Vec3{0.5, 0.5, 0.5}},
			true},
		{Sphere{glm.Vec3{0, 1.5, 0}, 1}, AABB{glm.Vec3{}, glm.Vec3{0.5, 0.5, 0.5}},
			true},
		{Sphere{glm.Vec3{0, 2, 0}, 1}, AABB{glm.Vec3{}, glm.Vec3{0.5, 0.5, 0.5}},
			false},
		{Sphere{glm.Vec3{0, 2, 0}, 1}, AABB{glm.Vec3{0, 2, 0}, glm.Vec3{0.5, 0.5, 0.5}},
			true},
	}
	for i, test := range tests {
...
func TestTestSphereTriangle(t *testing.T) {
	tests := []struct {
		...
		{Sphere{glm.Vec3{}, 1},
			...
			true}, // 5
		{Sphere{glm.Vec3{0, 4, 0}, 1},
			glm.Vec3{0, 0, 0}, glm.Vec3{1, 0, 0}, glm.Vec3{0, 1, 0},
			false}, // 6
		{Sphere{glm.Vec3{0, 5, 0}, 1},
			glm.Vec3{0, 5, 0}, glm.Vec3{1, 5, 0}, glm.Vec3{0, 6, 0},
			true}, // 7
	}
	for i, test := range tests {
...
func TestIntersectSegmentPlane(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0},
			Plane{glm.Vec3{0, 1, 0}, 0.5},
			0.5, glm.Vec3{0, 0.5, 0}, true},

		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 0.4, 0},
			Plane{glm.Vec3{0, 1, 0}, 0.5},
			0, glm.Vec3{0, 0, 0}, false},
		{glm.Vec3{0, 0.6, 0}, glm.Vec3{0, 0.5, 0},
			Plane{glm.Vec3{0, 1, 0}, 0.5},
			1, glm.Vec3{0, 0.5, 0}, true},
	}
	for i, test := range tests {
...
func TestIntersectRaySphere(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{-10, 1, 0}, glm.Vec3{10, 1, 0},
			Sphere{glm.Vec3{0, 0, 0}, 2},
			0.49111938476562500, glm.Vec3{-5.08880615234375, 1.491119384765625, 0}, true}, // 4
...
func TestTestRaySphere(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{-10, 10, 0}, glm.Vec3{10, 10, 0},
			Sphere{glm.Vec3{0, 0, 0}, 2},
			false}, // 4
		{glm.Vec3{0, 0, -5}, glm.Vec3{0, 0.707, 0.707},
			Sphere{glm.Vec3{0, 0, 5}, 2},
			false}, // 5
		{glm.Vec3{0, 0, 5}, glm.Vec3{0, 0.707, 0.707},
			Sphere{glm.Vec3{0, 0, 5}, 2},
			true}, // 6
...
func TestIntersectRayAABB(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{-5, 0, 0}, glm.Vec3{1, 0, 0},
			AABB{glm.Vec3{0, 0, 0}, glm.Vec3{0.5, 0.5, 0.5}},
			4.5, glm.Vec3{-0.5, 0, 0}, true},
		{glm.Vec3{0, 5, 0}, glm.Vec3{0, -1, 0},
			AABB{glm.Vec3{0, 0, 0}, glm.Vec3{0.5, 0.5, 0.5}},
			4.5, glm.Vec3{0, 0.5, 0}, true},
		{glm.Vec3{0, 0, -5}, glm.Vec3{0, 0, 1},
			AABB{glm.Vec3{0, 0, 0}, glm.Vec3{0.5, 0.5, 0.5}},
			4.5, glm.Vec3{0, 0, -0.5}, true},
		{glm.Vec3{0, 0, -5}, glm.Vec3{0, 0, 1},
			AABB{glm.Vec3{0, 0, 0}, glm.Vec3{0.5, 0.5, math.Inf(1)}},
			0, glm.Vec3{0, 0, -5}, true},
	}
	for i, test := range tests {
...
func TestTestSegmentAABB(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{-5, 0, 0}, glm.Vec3{5, 0, 0},
			AABB{glm.Vec3{0, 0, 0}, glm.Vec3{0.5, 0.5, 0.5}},
			true},
		{glm.Vec3{-5, 10, 0}, glm.Vec3{5, 10, 0},
			AABB{glm.Vec3{0, 0, 0}, glm.Vec3{0.5, 0.5, 0.5}},
			false},
		{glm.Vec3{0, 0, 2}, glm.Vec3{0, 0, 3},
			AABB{glm.Vec3{0, 0, 0}, glm.Vec3{0.5, 0.5, 0.5}},
			false},
		{glm.Vec3{0.5, 0.5, 0.5}, glm.Vec3{0.5, 0.5, 0.5},
			AABB{glm.Vec3{0, 0, 0}, glm.Vec3{0.25, 0.25, 0.25}},
			false},
	}
	for i, test := range tests {
...
func TestIntersectSegmentTriangle(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{0, 0, 0}, glm.Vec3{0, 1, 0},
			glm.Vec3{0, 0.5, 0}, glm.Vec3{1, 0.5, 0}, glm.Vec3{0, 0.5, 1},
			1, 0, 0, 0.5,
			true}, // 5
...
func TestIntersectSegmentQuad(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{0, -0.5, 0}, glm.Vec3{0, 0.5, 0},
			glm.Vec3{-1, 0, -1}, glm.Vec3{1, 0, -1}, glm.Vec3{1, 0, 1}, glm.Vec3{-1, 0, 1},
			glm.Vec3{},
			true}, // 6
		{glm.Vec3{0.3, -0.5, 0}, glm.Vec3{0.3, 0.5, 0},
			glm.Vec3{-1, 0, -1}, glm.Vec3{1, 0, -1}, glm.Vec3{1, 0, 1}, glm.Vec3{-1, 0, 1},
			glm.Vec3{0.3, 0, 0},
			true}, // 7
	}
...
func TestIntersectSegmentCylinder(t *testing.T) {
	tests := []struct {
		...
		{glm.Vec3{-10, 0, 0}, glm.Vec3{10, 0, 0},
			glm.Vec3{0, -10, 0}, glm.Vec3{0, 10, 0}, 1,
			0.45, true},
		{glm.Vec3{-10, 1, 0}, glm.Vec3{10, 1, 0},
			glm.Vec3{0, -10, 0}, glm.Vec3{0, 10, 0}, 1,
			0.45, true},
		{glm.Vec3{-10, 0, 1}, glm.Vec3{10, 0, 1},
			glm.Vec3{0, -10, 0}, glm.Vec3{0, 10, 0}, 1,
			0.5, true},
		...
		{glm.Vec3{0, -1, 0}, glm.Vec3{0, 1, 0},
			glm.Vec3{-5, 5, 0}, glm.Vec3{5, 5, 0}, 1,
			0, false},
		{glm.Vec3{0, 0, 0}, glm.Vec3{2, 0, 0},
			glm.Vec3{1, 0, 0}, glm.Vec3{3, 0, 0}, 1,
			0.5, true}, // 11
		{glm.Vec3{3, 0, 0}, glm.Vec3{1, 0, 0},
			glm.Vec3{0, 0, 0}, glm.Vec3{2, 0, 0}, 1,
			0.5, true}, // 12
