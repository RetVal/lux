...
func TestSimplex_Merge(t *testing.T) {
	...
	tests := []struct {
		...
		{Simplex{[4]glm.Vec3{{0, 1, 0}, {0, 2, 0}, {}, {}}, 2},
			glm.Vec3{X: 0, Y: 3, Z: 0},
			Simplex{[4]glm.Vec3{{0, 1, 0}, {0, 2, 0}, {0, 3, 0}, {}}, 3}},
		{Simplex{[4]glm.Vec3{{0, 1, 0}, {0, 2, 0}, {0, 3, 0}, {}}, 3},
			glm.Vec3{X: 0, Y: 4, Z: 0},
...
func TestSimplex_NearestToOrigin(t *testing.T) {
	tests := []struct {
		...
		{ // 4
			...
			direction:      glm.Vec3{X: 0.70710676908493042, Y: -0.70710676908493042, Z: 0},
			containsOrigin: false,
			reduced:        Simplex{[4]glm.Vec3{{-1, 1, 0}, {}, {}, {}}, 1},
		},
		{ // 5
			simplex:        Simplex{[4]glm.Vec3{{-2, 1, 0}, {-1, 2, 0}, {}, {}}, 2},
			direction:      glm.Vec3{X: 0.70710682868957520, Y: -0.70710682868957520, Z: 0},
			containsOrigin: false,
		...
		{ // 8
			...
			direction:      glm.Vec3{X: 0, Y: 0, Z: 1},
			containsOrigin: false,
			reduced:        Simplex{[4]glm.Vec3{{0, 0, -4}, {}, {}, {}}, 1},
		},
		{ // 9
			simplex:        Simplex{[4]glm.Vec3{{-1 - 2, 0, -1}, {0 - 2, 0, 1}, {1 - 2, 0, -1}, {}}, 3},
			direction:      glm.Vec3{X: 0.89442718029022217, Y: 0, Z: 0.44721359014511108},
			containsOrigin: false,
		...
		{ // 12
			...
			direction:      glm.Vec3{X: -0.97014254331588745, Y: 0, Z: 0.24253563582897186},
			containsOrigin: false,
		...
		{ // 16 botom forward
			...
			direction:      glm.Vec3{X: 0, Y: 0.11043152213096619, Z: 0.99388372898101807},
			containsOrigin: false,
			reduced:        Simplex{[4]glm.Vec3{{0, -1, 1 - 10}, {}, {}, {}}, 1},
		},
		{ // 17 left vertex
			simplex:        Simplex{[4]glm.Vec3{{-1 + 10, -1, -1}, {0 + 10, -1, 1}, {1 + 10, -1, -1}, {0 + 10, 1, 0}}, 4},
			direction:      glm.Vec3{X: -0.98787838220596313, Y: 0.10976426303386688, Z: 0.10976426303386688},
			containsOrigin: false,
